          ...
          <List>
            ...
            {/* {this.state.userList != undefined ? this.renderUserList : this.renderEmptyUserlist} */}
            {
              ...
              Object.keys(userList).map((e) => {
                var ubicacion = false;
                console.log(Object.getOwnPropertyNames(userList[e]))
                if (userList[e].hasOwnProperty("UserLocation")) {
                  if(userList[e].UserLocation.hasOwnProperty("status")){
                    if (userList[e].UserLocation.status == true) {
                      
                      console.log(userList[e].UserLocation.status)
